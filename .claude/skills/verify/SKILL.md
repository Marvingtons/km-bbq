...
- Hero media (HeroVideo holds the poster while `preloading`, then plays): `/images/hero-ember.jpg`, `/videos/hero-ember.mp4` (a seamless ~2s charcoal-ember loop). The preloader itself is time-based and gates on nothing.

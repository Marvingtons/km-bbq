...
// single source. (The hero's CTA is its own cream-filled variant, since ember
// sits inside the video's hue range and stops reading as a control over it;
// the red game dome is a prop, not a button.)
const PILL =

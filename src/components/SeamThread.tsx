 ...
 * (stroke-dashoffset scrubbed by SeamMotion). Same weight, color, and length at
 * every seam, so each boundary is stitched with one quiet signature.
 *
 * Defaults to fully drawn (dashoffset 0) so no-JS / reduced-motion shows a
...
export function SeamThread() {
  return (
    ...
    >
      <svg width="2" height="72" viewBox="0 0 2 72" className="block overflow-visible">
        <line
